...
CONSUMER_KEY = 'YrvGUIRWnqUM6QjxwFRgGQ'
CONSUMER_SECRET = 'uLAZJrMPTbk2dL8draiL8BJyJIIn8L0z3uwHcCGfOw'
...
#tokyo precise
#TWITTER_STREAM_API_PATH = '/1.1/statuses/filter.json?locations=-139.52,35.55,-138.52,36.55'
#tokyo wide
#TWITTER_STREAM_API_PATH = '/1.1/statuses/filter.json?locations=-145.52,33.55,-135.52,39.55'
#sanfran
TWITTER_STREAM_API_PATH = '/1.1/statuses/filter.json?locations=-122.75,36.8,-121.75,37.8'
